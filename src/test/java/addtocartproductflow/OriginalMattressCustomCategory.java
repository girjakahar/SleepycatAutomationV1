...
public class OriginalMattressCustomCategory extends BaseSleepycat {
    ...
    @Test
	public void originalMattessCustomAddToCart() throws Exception
	{
	   ...
	   log.error("Clicked on add to cart button");
	    ...
	    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='cart_item_mid']//div[@data-product_sku='SC-ORIG-Q-75x60x6']")));
		
		boolean productname = driver.findElement(By.xpath("//div[@class='cart_item_mid']//div[@data-product_sku='SC-ORIG-Q-75x60x6']")).isDisplayed();
		if(productname) 
		{
			System.out.println("Custom Category Original Mattress Product is added in cart");
			log.error("Custom Category Original Mattress Product is added in cart");
		}else
		{
			System.out.println("Custom Category Original Mattress Product is not added in cart");
			log.error("Custom Category Original Mattress Product is not added in cart");
		}	
