...
public class OhayoBedProductDetailsChanges extends BaseSleepycat {
	...
	public void startingDriver() throws IOException
	{
	 ...
	 @Test
		public void ohayoBedAddToCart() throws Exception
		{
		   ...
		   landingpage.offerModal();
		   wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='cart_item_mid']//div[@data-product_sku='SC-OHAYOBED-K-84x77x13']")));
			
			boolean productname = driver.findElement(By.xpath("//div[@class='cart_item_mid']//div[@data-product_sku='SC-OHAYOBED-K-84x77x13']")).isDisplayed();
			if(productname) 
			{
				System.out.println("King category Ohayo Bed Product is added in cart");
				log.error("King category Ohayo Bed Product is added in cart");
			}else
			{
				System.out.println("King category Ohayo Bed Product is not added in cart");
				log.error("King category Ohayo Bed Product is not added in cart");
			}	
		}
